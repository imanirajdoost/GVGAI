...
public class Bfs {
  private static final int MAX_NUM_SEEN_STATES = 12000;
  private static final int MAX_NUM_STORED_SEQUENCES = 200;
  private static final int MAX_QUEUES_TOTAL_SIZE = 6500;
  ...
  private Set<Set<Long>> seenStates;
  ...
  private void runBfs(ElapsedCpuTimer timer) {
    ...
    while (this.queuesTotalSize() > 0) {
      ...
      Set<Long> atomsState = ((Atom1Set)curAtomSets.get(1)).getAtoms();
