...
public class AStar {
    ...
    private void expandNode(AStarNode node, StateObservation state) {
        ...
        if (hasUseAction) {
        	expandNodeWithAction(node, state, ACTIONS.ACTION_USE );
        }
        
        expandNodeWithAction(node, state, ACTIONS.ACTION_RIGHT);
        expandNodeWithAction(node, state, ACTIONS.ACTION_LEFT);
        expandNodeWithAction(node, state, ACTIONS.ACTION_DOWN);
        expandNodeWithAction(node, state, ACTIONS.ACTION_UP);
    }
	...
	private void expandNodeWithAction( AStarNode node, StateObservation lastState, ACTIONS action) {
